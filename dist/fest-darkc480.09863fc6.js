$(document).ready(function() {
    ...
    if (document.getElementById("lightgallery")) $("#lightgallery").lightGallery();
    ...
    $("#countdown").countdown("2017/11/01", function(event) {
        $(this).html(event.strftime('<span class="timer__item">%D<span class="timer__item-caption">days</span></span><span class="timer__item">%H<span class="timer__item-caption">hours</span></span><span class="timer__item">%M<span class="timer__item-caption">min</span></span><span class="timer__item">%S<span class="timer__item-caption">sec</span></span>'));
    });
    // Video
    ...
    if (document.querySelector("#tracklist")) {
        ...
        $(".volume-slider").slider({
            ...
            change: function() {
                ...
                if (value === 0 && !$(".volume-icon").hasClass("volume-icon--mute")) $(".volume-icon").addClass("volume-icon--mute");
                else if (value > 0) $(".volume-icon").removeClass("volume-icon--mute");
            },
            slide: function() {
                var value = $(".volume-slider").slider("value");
                audio.element.volume = value / 100;
    ...
    var toggleMobileMenu = function() {
        if ($(window).width() < 768) $(".menu-collapsed").toggleClass("menu-expanded");
    };
    // Ticket card mouseover effect
    var screenWidth = window.screen.width / 2, screenHeight = window.screen.height / 2, elem = $(".js-ticket"), perspective = "perspective(700px)";
    elem.on("mousemove", function(e) {
        var centroX = e.clientX - screenWidth, centroY = screenHeight - e.clientY, degX = centroX * 0.02, degY = centroY * 0.02;
        $(e.currentTarget).css({
...
//# sourceMappingURL=fest-darkc480.09863fc6.js.map
