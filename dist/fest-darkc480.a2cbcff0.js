...
* Copyright jQuery Foundation and other contributors; Licensed MIT */ (function(t) {
    ...
    t.cleanData = function(e) {
        ...
        t.position = {
            ...
            return _ = s(v), v[0].preventDefault && (n.at = "left top"), p = _.width, f = _.height, g = _.offset, m = t.extend({}, g), t.each([
                "my",
                "at"
            ], function() {
    ...
    t.extend(s.prototype, {
        ...
        TIMESTAMP: "@",
        W3C: "yy-mm-dd",
        _ticksTo1970: 1e7 * 86400 * (718685 + Math.floor(492.5) - Math.floor(19.7) + Math.floor(4.925)),
    ...
    t(document).on("mouseup", function() {
        ...
        resize: function(e, i) {
            ...
            t(n.alsoResize).each(function() {
                var e = t(this), s = t(this).data("ui-resizable-alsoresize"), n = {}, o = e.parents(i.originalElement[0]).length ? [
                    "width",
                    "height"
                ] : [
                    "width",
    ...
    t.ui.ddmanager = {
        ...
        _contactContainers: function(e) {
            ...
            for(i = this.containers.length - 1; i >= 0; i--)if (!t.contains(this.currentItem[0], this.containers[i].element[0])) {
...
//# sourceMappingURL=fest-darkc480.a2cbcff0.js.map
